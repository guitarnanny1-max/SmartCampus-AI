...
export default function TeacherProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-fuchsia-50/50">
      <div className="mx-auto max-w-7xl px-6 py-8 lg:px-8">
        ...
        <div className="mt-5 overflow-hidden rounded-3xl border border-slate-200 bg-white">
          <div className="border-b border-purple-100 bg-gradient-to-br from-purple-50/70 via-white to-fuchsia-50/50 px-6 py-7">
            <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-4">
                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-600 via-fuchsia-600 to-pink-600 text-xl font-bold text-white shadow-lg shadow-fuchsia-200">
              ...
              <div className="flex gap-3">
                ...
                <Link
                  href="/app/teachers"
                  className="rounded-xl bg-gradient-to-r from-purple-600 to-fuchsia-600 px-4 py-2.5 text-sm font-bold text-white shadow-md shadow-fuchsia-200 transition hover:-translate-y-0.5 hover:from-purple-700 hover:to-fuchsia-700"
                >
                  Back
                </Link>
              </div>
          ...
          {editingProfile && (
            <form
              ...
              className="border-t border-purple-100 bg-gradient-to-br from-purple-50/70 via-white to-fuchsia-50/50 p-6"
            >
              <div className="mb-5">
              ...
              <div className="mt-6 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={savingProfile}
                  className="rounded-xl bg-gradient-to-r from-purple-600 via-fuchsia-600 to-pink-600 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-fuchsia-200 transition hover:-translate-y-0.5 hover:from-purple-700 hover:to-pink-700 disabled:cursor-not-allowed disabled:opacity-50"
                >
        ...
        <div className="mt-6 overflow-hidden rounded-2xl border border-purple-100 bg-white shadow-sm">
          ...
          {showAssignmentForm && (
            <form
              ...
              className="mb-6 rounded-2xl border border-purple-100 bg-gradient-to-br from-purple-50/70 via-white to-fuchsia-50/50 p-5"
            >
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          {assignments.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[900px] text-left">
                <thead>
                  <tr className="border-b border-purple-100 bg-gradient-to-br from-purple-50/70 via-white to-fuchsia-50/50">
        ...
        <section
          id="teacher-activity"
          className="mt-8 rounded-2xl border border-purple-100 bg-white shadow-sm p-6 shadow-sm"
        >
        ...
        <section className="mt-6 space-y-6">
          ...
          {(() => {
            ...
            function statusClass(status: string) {
              switch (status) {
                ...
                default:
                  return "border-purple-100 bg-gradient-to-br from-purple-50/70 via-white to-fuchsia-50/50 text-slate-700";
              }
            }
            ...
            return (
              <>
                {/* Header */}
                <div className="overflow-hidden rounded-2xl border border-purple-100 bg-white shadow-sm shadow-sm">
                  <div className="flex flex-col gap-4 border-b border-slate-200 p-5 sm:p-6 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div className="rounded-xl border border-purple-100 bg-gradient-to-br from-purple-50/70 via-white to-fuchsia-50/50 px-4 py-3">
                      <p className="text-xs font-semibold uppercase tracking-wide text-slate-400">
                        Attendance rate
                      </p>
          ...
          {activities.length === 0 ? (
            <div className="rounded-xl border border-dashed border-purple-100 bg-gradient-to-br from-purple-50/70 via-white to-fuchsia-50/50 p-8 text-center">
              ...
              {activities.map((activity, index) => {
                ...
                return (
                  <div key={activity.id} className="relative flex gap-4">
                    ...
                    <div className="min-w-0 flex-1 rounded-xl border border-purple-100 bg-gradient-to-br from-purple-50/70 via-white to-fuchsia-50/50 p-4">
