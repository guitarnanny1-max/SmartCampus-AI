...
ensureSchoolRelation("SmartHostelHub");

const modelRegex = /model SmartHostelHub \{[^}]+\}/;
const newModel = `model SmartHostelHub {
...
console.log("✅ Updated SmartHostelHub model with hostelBlock and all required fields.");
