...
print("⚙️ Adding SmartAutonomousFleetHub model to Prisma schema...")
...
model Tenant {
  ...
  smartAutonomousFleetHubs SmartAutonomousFleetHub[]
...
model SmartAutonomousFleetHub {
  id           String   @id @default(cuid())
  fleetName    String   @default("Autonomous Vehicle")
...
print("✨ Updated schema.prisma with SmartAutonomousFleetHub successfully!")
