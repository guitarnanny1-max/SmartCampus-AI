...
ensureSchoolRelation("SmartFeatureToggleHub");

const modelRegex = /model SmartFeatureToggleHub \{[^}]+\}/;
const newModel = `model SmartFeatureToggleHub {
...
console.log("✅ Added SmartFeatureToggleHub model and relation successfully.");
