...
print("⚙️ Updating Prisma schema with Onboarding models...")
...
print("✨ Updated prisma/schema.prisma with OnboardingStep & SchoolOnboardingPipeline!")

print("⚙️ Writing Super Admin pipelines API route...")
api_dir = "src/app/api/admin/onboarding/pipelines"
...
export async function GET() {
  try {
    const pipelines = await prisma.schoolOnboardingPipeline.findMany({
...
try:
    ...
    print("\n🎉 SUCCESS! Onboarding pipeline API and schema compiled successfully with zero errors!")
