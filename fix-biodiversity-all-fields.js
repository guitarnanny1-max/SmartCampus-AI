...
const newModel = `model SmartBiodiversityHub {
  ...
  habitatRestorationIdx      Float?
  aiAcousticClassification   String?
  status                     String?
  notes                      String?
...
console.log("✅ Updated SmartBiodiversityHub model with habitatRestorationIdx and aiAcousticClassification.");
