...
if (schoolMatch) {
  ...
  if (!schoolBody.includes("studentRiskAssessments")) {
    const lines = schoolBody.split("\n");
    const filteredLines = lines.filter(line => line.trim() !== "}");
    filteredLines.push("  studentRiskAssessments StudentRiskAssessment[]");
...
console.log("✅ Added StudentRiskAssessment model and relation successfully.");
