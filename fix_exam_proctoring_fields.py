...
print("⚙️ Updating ExamProctoringSession model with all required fields in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma successfully with ExamProctoringSession fields!")
