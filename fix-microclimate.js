...
ensureSchoolRelation("SmartMicroclimateHub");

const modelRegex = /model SmartMicroclimateHub \{[^}]+\}/;
const newModel = `model SmartMicroclimateHub {
...
console.log("✅ Added SmartMicroclimateHub model and relation successfully.");
