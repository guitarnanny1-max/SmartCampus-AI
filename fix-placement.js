...
ensureSchoolRelation("SmartPlacementHub");

const modelRegex = /model SmartPlacementHub \{[^}]+\}/;
const newModel = `model SmartPlacementHub {
  id                String   @id @default(cuid())
  schoolId          String
  school            School   @relation(fields: [schoolId], references: [id], onDelete: Cascade)
  studentName       String?
  companyName       String?
  packageCpaInLakhs Float?
  jobRole           String?
  offerStatus       String?
...
console.log("✅ Updated SmartPlacementHub model with packageCpaInLakhs, studentName, companyName, jobRole, offerStatus, and other fields.");
