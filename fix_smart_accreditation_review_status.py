...
print("⚙️ Adding reviewStatus field to SmartAccreditationHub model in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma with reviewStatus field successfully!")
