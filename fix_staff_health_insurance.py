...
def update_schema():
    ...
    # Define SmartStaffHealthHub model with insuranceSuggestion included
    model_def = """model SmartStaffHealthHub {
  ...
  staffEmail          String?
  department          String?
  stepsToday          Int      @default(5000)
  walkingDistanceKm   String?  @default("3.5 km")
  heartRateAvg        String?  @default("72 bpm")
  wellnessStatus      String?  @default("EXCELLENT")
  socialMediaId       String?
  insuranceSuggestion String?  @default("Standard Health Plan")
  ...
  updatedAt           DateTime @updatedAt
    ...
    schema = re.sub(r'model SmartStaffHealthHub\s*\{[^}]*\}', '', schema)
    schema += "\n\n" + model_def
    ...
    if "model School" in schema:
        ...
        if school_match:
            ...
            if "smartStaffHealthHubs" not in school_body:
    ...
    if "model Tenant" in schema:
        ...
        if tenant_match:
            ...
            if "smartStaffHealthHubs" not in tenant_body:
    ...
    print("✨ Successfully updated schema with insuranceSuggestion in SmartStaffHealthHub!")
    return True
