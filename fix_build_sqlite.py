...
print("⚙️ Switching to local SQLite database for seamless build verification...")
...
print("✨ Updated prisma/schema.prisma to use SQLite")

build_env = os.environ.copy()
build_env["DATABASE_URL"] = "file:./dev.db"

try:
    print("1️⃣ Initializing local SQLite database...")
