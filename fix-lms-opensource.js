...
ensureSchoolRelation("SmartLmsOpenSource");

const modelRegex = /model SmartLmsOpenSource \{[^}]+\}/;
const newModel = `model SmartLmsOpenSource {
...
console.log("✅ Added SmartLmsOpenSource model and relation successfully.");
