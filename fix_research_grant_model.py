...
print("⚙️ Adding ResearchGrant model and relations to Prisma schema...")
...
print("✨ Updated prisma/schema.prisma successfully with ResearchGrant!")
