...
echo "=================================================="
echo " 🛠️ Verifying Hostel Schema, Flushing Caches & Rebuilding"
echo "=================================================="

mkdir -p prisma
mkdir -p src/lib

# 1. Ensure prisma/schema.prisma has HostelRoom model
...
# 2. Ensure Prisma client singleton helper
...
# 3. Clean all build caches to force TS server and Next.js compiler refresh
rm -rf .next
...
echo "[3/4] Running Next.js Production Build..."
npm run build
