...
# Completely remove any existing User definition
schema = re.sub(r'model User\s*\{[^}]*\}', '', schema)

# Define the full model with user/team fields
model_def = """
model User {
