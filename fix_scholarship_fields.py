...
print("⚙️ Updating ScholarshipApplication model fields in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma with ScholarshipApplication fields successfully!")
