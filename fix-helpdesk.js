...
ensureSchoolRelation("SmartHelpdeskTicket");

const modelRegex = /model SmartHelpdeskTicket \{[^}]+\}/;
const newModel = `model SmartHelpdeskTicket {
...
console.log("✅ Added SmartHelpdeskTicket model and relation successfully.");
