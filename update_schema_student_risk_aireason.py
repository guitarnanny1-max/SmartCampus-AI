...
# Define the full model with all required student risk fields including aiReason
model_def = """
model StudentRiskAssessment {
  ...
  aiReason           String?  @default("AI calculated risk assessment based on performance metrics.")
