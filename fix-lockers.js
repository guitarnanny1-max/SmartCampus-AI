...
ensureSchoolRelation("SmartLockerDelivery");

const modelRegex = /model SmartLockerDelivery \{[^}]+\}/;
const newModel = `model SmartLockerDelivery {
...
console.log("✅ Added SmartLockerDelivery model and relation successfully.");
