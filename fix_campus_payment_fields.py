...
print("⚙️ Updating CampusPaymentRecord model with amountInr and paymentMethod fields in Prisma schema...")
...
model CampusPaymentRecord {
  id            String   @id @default(cuid())
  orderId       String   @default("ORDER-01")
  amount        Float    @default(0.0)
...
print("✨ Updated prisma/schema.prisma successfully!")
