...
print("⚙️ Updating CounselingSession model fields in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma with counselor and notes fields on CounselingSession!")
