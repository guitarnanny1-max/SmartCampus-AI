...
ensureSchoolRelation("SmartSubscriptionHub");

const modelRegex = /model SmartSubscriptionHub \{[^}]+\}/;
const newModel = `model SmartSubscriptionHub {
...
console.log("✅ Added SmartSubscriptionHub model and relation successfully.");
