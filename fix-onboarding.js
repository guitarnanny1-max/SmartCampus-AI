...
ensureSchoolRelation("SmartOnboardingHub");

const modelRegex = /model SmartOnboardingHub \{[^}]+\}/;
const newModel = `model SmartOnboardingHub {
...
console.log("✅ Added SmartOnboardingHub model and relation successfully.");
