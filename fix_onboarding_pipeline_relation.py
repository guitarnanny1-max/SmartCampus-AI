...
print("⚙️ Fixing SchoolOnboardingPipeline relation in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma successfully with SchoolOnboardingPipeline relation!")
