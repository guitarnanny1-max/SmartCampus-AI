...
print("⚙️ Adding invigilatorName field to ExamProctoringSession model in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma successfully with invigilatorName!")
