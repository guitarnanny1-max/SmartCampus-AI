...
ensureSchoolRelation("SmartExamProctorHub");

const modelRegex = /model SmartExamProctorHub \{[^}]+\}/;
const newModel = `model SmartExamProctorHub {
...
console.log("✅ Added SmartExamProctorHub model and relation successfully.");
