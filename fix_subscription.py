...
def update_schema():
    ...
    # Define SmartSubscriptionHub model
    model_def = """model SmartSubscriptionHub {
  id                 String   @id @default(uuid())
  tenantId           String?
  tenant             Tenant?  @relation(fields: [tenantId], references: [id], onDelete: Cascade)
  schoolId           String?
  school             School?  @relation(fields: [schoolId], references: [id], onDelete: Cascade)
  planName           String?  @default("Enterprise Tier")
  ...
  updatedAt          DateTime @updatedAt
    ...
    if "model School" in schema:
        ...
        if school_match:
            ...
            if "smartSubscriptionHubs" not in school_body:
                new_school_body = school_body.rstrip() + "\n  smartSubscriptionHubs SmartSubscriptionHub[]\n"
    ...
    if "model Tenant" in schema:
        ...
        if tenant_match:
            ...
            if "smartSubscriptionHubs" not in tenant_body:
    ...
    print("✨ Successfully updated schema with SmartSubscriptionHub!")
    return True
