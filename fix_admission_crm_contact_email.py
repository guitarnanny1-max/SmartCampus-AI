...
print("⚙️ Adding contactEmail field to SmartAdmissionCrmHub model in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma with contactEmail field successfully!")
