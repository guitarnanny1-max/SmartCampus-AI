...
ensureSchoolRelation("SmartStudentResume");

const modelRegex = /model SmartStudentResume \{[^}]+\}/;
const newModel = `model SmartStudentResume {
...
console.log("✅ Added SmartStudentResume model and relation successfully.");
