...
print("⚙️ Adding DigitalCredential model to Prisma schema...")
...
model DigitalCredential {
  ...
  recipientName String   @default("Student")
...
print("✨ Updated prisma/schema.prisma with DigitalCredential model!")
