...
if (schoolMatch) {
  ...
  if (!schoolBody.includes("smartTurnstileAccesses")) {
    const lines = schoolBody.split("\n");
    const filteredLines = lines.filter(line => line.trim() !== "}");
    filteredLines.push("  smartTurnstileAccesses SmartTurnstileAccess[]");
...
console.log("✅ Added SmartTurnstileAccess model and relation successfully.");
