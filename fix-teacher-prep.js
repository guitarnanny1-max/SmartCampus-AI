...
ensureSchoolRelation("SmartTeacherPrepHub");

const modelRegex = /model SmartTeacherPrepHub \{[^}]+\}/;
const newModel = `model SmartTeacherPrepHub {
...
console.log("✅ Added SmartTeacherPrepHub model and relation successfully.");
