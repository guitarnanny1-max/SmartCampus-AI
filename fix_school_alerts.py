...
print("⚙️ Adding alerts relation to School model and updating Alert model in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma with alerts relation successfully!")
