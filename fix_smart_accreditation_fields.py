...
print("⚙️ Adding complete fields to SmartAccreditationHub model in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma with full SmartAccreditationHub fields successfully!")
