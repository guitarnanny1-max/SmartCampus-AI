...
if (schoolMatch) {
  ...
  if (!schoolBody.includes("smartWastewaterReclamationHubs")) {
    const lines = schoolBody.split("\n");
    const filteredLines = lines.filter(line => line.trim() !== "}");
    filteredLines.push("  smartWastewaterReclamationHubs SmartWastewaterReclamationHub[]");
...
console.log("✅ Added SmartWastewaterReclamationHub model and relation successfully.");
