...
def update_schema():
    ...
    # Define SmartRoboticsLabHub model
    model_def = """model SmartRoboticsLabHub {
  ...
  labName            String?
  labCode            String?
  robotCount         Int      @default(12)
  aiNavigationStatus String   @default("ACTIVE")
  safetyProtocol     String   @default("ENABLED")
  ...
  updatedAt          DateTime @updatedAt
    ...
    schema = re.sub(r'model SmartRoboticsLabHub\s*\{[^}]*\}', '', schema)
    schema += "\n\n" + model_def
    ...
    if "model School" in schema:
        ...
        if school_match:
            ...
            if "smartRoboticsLabHubs" not in school_body:
                new_school_body = school_body.rstrip() + "\n  smartRoboticsLabHubs SmartRoboticsLabHub[]\n"
    ...
    if "model Tenant" in schema:
        ...
        if tenant_match:
            ...
            if "smartRoboticsLabHubs" not in tenant_body:
    ...
    print("✨ Successfully updated schema with SmartRoboticsLabHub!")
    return True
