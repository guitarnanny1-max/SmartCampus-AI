...
print("⚙️ Adding CounselingSession model to Prisma schema...")
...
model CounselingSession {
  ...
  counselorName String   @default("Counselor")
...
print("✨ Updated prisma/schema.prisma with CounselingSession model!")
