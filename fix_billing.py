...
def update_schema():
    ...
    # Define SmartPaymentBillingHub model with all fields referenced in the API route
    model_def = """model SmartPaymentBillingHub {
  ...
  payerName          String?
  amountInr          Float    @default(50000.0)
  paymentGateway     String?
  billingStatus      String?  @default("SUCCESSFUL")
  ...
  updatedAt          DateTime @updatedAt
    ...
    schema = re.sub(r'model SmartPaymentBillingHub\s*\{[^}]*\}', '', schema)
    ...
    if school_match:
        ...
        rel = "  smartPaymentBillingHubs SmartPaymentBillingHub[]"
        if "smartPaymentBillingHubs" not in school_body:
    ...
    if tenant_match:
        ...
        rel = "  smartPaymentBillingHubs SmartPaymentBillingHub[]"
        if "smartPaymentBillingHubs" not in tenant_body:
    ...
    print("✨ Successfully updated SmartPaymentBillingHub schema!")
    return True
