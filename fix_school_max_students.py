...
print("⚙️ Adding maxStudents and placements relation to School model in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma with maxStudents and placements model successfully!")
