...
print("⚙️ Adding SmartStaffHealthHub and SmartLmsOpenSource models and relations to Prisma schema...")
...
print("✨ Updated prisma/schema.prisma successfully with SmartStaffHealthHub and SmartLmsOpenSource!")
