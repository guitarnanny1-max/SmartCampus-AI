...
if (schoolMatch) {
  ...
  if (!schoolBody.includes("smartWaterReservoirs")) {
    const lines = schoolBody.split("\n");
    const filteredLines = lines.filter(line => line.trim() !== "}");
    filteredLines.push("  smartWaterReservoirs SmartWaterReservoir[]");
...
console.log("✅ Added SmartWaterReservoir model and relation successfully.");
