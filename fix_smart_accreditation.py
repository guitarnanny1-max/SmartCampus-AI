...
print("⚙️ Adding SmartAccreditationHub model and relation to Prisma schema...")
...
print("✨ Updated prisma/schema.prisma with SmartAccreditationHub model successfully!")
