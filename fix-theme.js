...
ensureSchoolRelation("SmartThemeHub");

const modelRegex = /model SmartThemeHub \{[^}]+\}/;
const newModel = `model SmartThemeHub {
...
console.log("✅ Added SmartThemeHub model and relation successfully.");
