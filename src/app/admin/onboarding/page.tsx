  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-6">
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 space-y-4">
        ...
        <h1 className="text-3xl font-bold text-gray-900 capitalize">onboarding Hub</h1>
        <p className="text-gray-600 text-base">
          Dedicated operational metrics, telemetry, tools, and management consoles for the onboarding division of SmartCampus AI.
        </p>
