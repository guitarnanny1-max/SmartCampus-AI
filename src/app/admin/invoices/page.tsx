      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8 border-b border-slate-800 pb-6">
          <div>
            ...
            <h1 className="text-3xl font-extrabold text-white mt-2">Admin Invoices</h1>
            <p className="text-slate-400 text-sm mt-1">Review subscription charges, billing status, and revenue streams.</p>
          </div>
