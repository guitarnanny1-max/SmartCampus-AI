...
print("⚙️ Updating SmartAdmissionCrmHub model with missing fields in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma with SmartAdmissionCrmHub fields successfully!")
