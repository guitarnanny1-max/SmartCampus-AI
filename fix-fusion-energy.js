...
ensureSchoolRelation("SmartFusionEnergyHub");

const modelRegex = /model SmartFusionEnergyHub \{[^}]+\}/;
const newModel = `model SmartFusionEnergyHub {
  id                   String   @id @default(cuid())
  schoolId             String
  school               School   @relation(fields: [schoolId], references: [id], onDelete: Cascade)
  reactorCode          String?
  reactorName          String?
  plasmaTempKelvin     Float?
  magneticFieldTesla   Float?
  fusionPowerMw        Float?
  aiConfinementMode    String?
  status               String?
  notes                String?
...
console.log("✅ Added SmartFusionEnergyHub model and relation successfully.");
