...
print("⚙️ Adding assignedTechnician field to MaintenanceWorkOrder model in Prisma schema...")
...
print("✨ Updated prisma/schema.prisma with assignedTechnician field!")
