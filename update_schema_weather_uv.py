...
# Define the full model with all required weather station fields including uvIndex and weatherAlertStatus
model_def = """
model SmartWeatherStation {
  ...
  windSpeedKmh                   Float?   @default(12.5)
  barometricPressureHpa          Float?   @default(1013.25)
  ambientTemperatureC            Float?   @default(25.0)
  relativeHumidityPct            Float?   @default(50.0)
  uvIndex                        Float?   @default(4.2)
  precipitationMm                Float?   @default(0.0)
  solarIrradianceWm2             Float?   @default(500.0)
  weatherAlertStatus             String?  @default("NORMAL")
  aiMeteorologicalPredictionModel String?  @default("ADVANCED_ATMOSPHERIC_MODEL")
